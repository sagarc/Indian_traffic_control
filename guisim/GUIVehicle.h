...
/// @date    Sept 2002
/// @version $Id: GUIVehicle.h 8566 2010-04-06 07:45:21Z dkrajzew $
///
...
public:
    ...
    size_t getMainStripNumericalID() const throw();//?? ACE ??
    SUMOReal getRealWidth() const throw();//?? ACE ??
    bool isMainStrip(const MSStrip &strip) const;//?? ACE ??
