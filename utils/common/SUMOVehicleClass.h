...
/// @date    2006-01-24
/// @version $Id: SUMOVehicleClass.h 8581 2010-04-10 13:52:27Z dkrajzew $
///
...
const std::string CF_MODEL_IITBNN = CF_MODEL_PREFIX + "IITBNN";
const char * const CF_MODEL_IITBNN_STR = CF_MODEL_IITBNN.c_str();
...
const size_t   DEFAULT_VEH_STRIPWIDTH = (size_t) 2;
