...
/// @date    Sept 2002
/// @version $Id: SUMOXMLDefinitions.cpp 8708 2010-05-03 10:23:36Z behrisch $
///
...
GenericSAXHandler::Tag sumotags[] = {
    ...
    { CF_MODEL_IITBNN_STR,    SUMO_TAG_CF_IITBNN },
...
GenericSAXHandler::Attr sumoattrs[] = {
    ...
    { "stripWidth",     SUMO_ATTR_VEHSTRIPWIDTH },
    //{ "laneWidth",      SUMO_ATTR_LANEWIDTH },
