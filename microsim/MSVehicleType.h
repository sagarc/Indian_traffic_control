...
/// @version $Id: MSVehicleType.h 8579 2010-04-10 12:30:42Z dkrajzew $
///
...
public:
     ...
     */
    MSVehicleType(const std::string &id, SUMOReal length, size_t stripWidth, 
                  SUMOReal maxSpeed,
    ...
    /** @brief Get vehicle's strip width
     * @return The number of strips the vehicle occupies laterally
     */
    size_t  getStripWidth() const throw() {
        return myStripWidth;
    }
...
private:
    ...
    /// @brief Vehicles' width [in number of strips]
    size_t   myStripWidth;
