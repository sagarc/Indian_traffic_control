...
/// @date    Fri, 29.04.2005
/// @version $Id: MSLCM_DK2004.h 8236 2010-02-10 11:16:41Z behrisch $
///
//	�missingDescription�
/****************************************************************************/
...
// ===========================================================================
enum MyLCAEnum {
    LCA_AMBLOCKINGLEADER = 256, // 0   - 2^8
    LCA_AMBLOCKINGFOLLOWER = 512,// 1
    LCA_MRIGHT = 1024, // 2
    LCA_MLEFT = 2048,// 3
    LCA_UNBLOCK = 4096,// 4
    LCA_AMBLOCKINGFOLLOWER_DONTBRAKE = 8192,// 5
    LCA_AMBLOCKINGSECONDFOLLOWER = 16384, // 6   - 2^14
    LCA_KEEP1 = 65536,// 8      - 2^16
    LCA_KEEP2 = 131072,// 9
    LCA_AMBACKBLOCKER = 262144,// 10
    LCA_AMBACKBLOCKER_STANDING = 524288// 11   - 2^19
