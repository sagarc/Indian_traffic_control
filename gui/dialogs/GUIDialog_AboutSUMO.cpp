...
/// @date    Mon, 08.03.2004
/// @version $Id: GUIDialog_AboutSUMO.cpp 8760 2010-05-19 11:04:52Z dkrajzew $
///
...
GUIDialog_AboutSUMO::GUIDialog_AboutSUMO(FXWindow* parent,  const char* name, int x, int y) throw()
    ...
    new FXLabel(f3, "Copyright 2001-2010 DLR / Institute of Transportation Systems", 0, LAYOUT_CENTER_X|JUSTIFY_CENTER_X|LABEL_NORMAL, 0,0,0,0, 0,0,0,0);
