...
/// @date    Mon, 9 Jul 2001
/// @version $Id: NLHandler.cpp 8757 2010-05-18 10:34:40Z dkrajzew $
///
...
NLHandler::beginEdgeParsing(const SUMOSAXAttributes &attrs) {
    ...
    myCurrentStripWidth = attrs.getIntReporting(SUMO_ATTR_NUMSTRIPS, "edge", id.c_str(), ok);
...
NLHandler::closeLane() {
    ...
    try {
        MSLane *lane =
            myEdgeControlBuilder.addLane(myCurrentLaneID, myCurrentMaxSpeed, myCurrentLength, myCurrentStripWidth, myLaneIsDepart, myShape, myAllowedClasses, myDisallowedClasses);
